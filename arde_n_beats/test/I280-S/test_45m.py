...
class config:
    ...
    ParaPath = '../../hypara/I280-S/parameter_d3.csv'
    SavePath = '../../hypara/I280-S/test_result_d3.csv'
    seed = 1109
...
def Test(x,D,round_no):
    ...
    np.savetxt('../../result/I280-S/prediction_d3.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/I280-S/groundtruth_d3.csv', y_test_save, delimiter=',')
