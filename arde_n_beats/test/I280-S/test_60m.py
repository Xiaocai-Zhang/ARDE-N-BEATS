...
class config:
    ...
    datapath = '../../data/I280-S/D_60m.csv'
    ParaPath = '../../hypara/I280-S/parameter_d4.csv'
    SavePath = '../../hypara/I280-S/test_result_d4.csv'
    seed = 1109
...
def Test(x,D,round_no):
    ...
    np.savetxt('../../result/I280-S/prediction_d4.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/I280-S/groundtruth_d4.csv', y_test_save, delimiter=',')
