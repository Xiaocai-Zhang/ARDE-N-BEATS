...
class config:
    ...
    datapath = '../../data/I280-S/D_15m.csv'
    ParaPath = '../../hypara/I280-S/parameter_d1.csv'
    SavePath = '../../hypara/I280-S/test_result_d1.csv'
    seed = 1109
...
def Test(x,D,round_no):
    ...
    np.savetxt('../../result/I280-S/prediction_d1.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/I280-S/groundtruth_d1.csv', y_test_save, delimiter=',')
