...
class config:
    ...
    datapath = '../../data/M50-N/D_45m.csv'
    ParaPath = '../../hypara/M50-N/parameter_d3.csv'
    SavePath = '../../hypara/M50-N/test_result_d3.csv'
    seed = 1076
...
def Test(x,D,round_no):
    ...
    SaveModlPath = '../../save/M50-N/D_' + str(D) + '/round_'+str(round_no)+'/'
    ...
    np.savetxt('../../result/M50-N/prediction_d3.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/M50-N/groundtruth_d3.csv', y_test_save, delimiter=',')
