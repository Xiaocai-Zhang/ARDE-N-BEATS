...
class config:
    ...
    datapath = '../../data/M50-N/D_30m.csv'
    ParaPath = '../../hypara/M50-N/parameter_d2.csv'
    SavePath = '../../hypara/M50-N/test_result_d2.csv'
    seed = 1076
...
def Test(x,D,round_no):
    ...
    np.savetxt('../../result/M50-N/prediction_d2.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/M50-N/groundtruth_d2.csv', y_test_save, delimiter=',')
