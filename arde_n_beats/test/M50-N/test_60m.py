...
class config:
    ...
    datapath = '../../data/M50-N/D_60m.csv'
    ParaPath = '../../hypara/M50-N/parameter_d4.csv'
    SavePath = '../../hypara/M50-N/test_result_d4.csv'
    seed = 1076
...
def Test(x,D,round_no):
    ...
    np.savetxt('../../result/M50-N/prediction_d4.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/M50-N/groundtruth_d4.csv', y_test_save, delimiter=',')
