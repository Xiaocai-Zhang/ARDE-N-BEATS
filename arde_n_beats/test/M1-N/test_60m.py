...
class config:
    ...
    datapath = '../../data/M1-N/D_60m.csv'
    ParaPath = '../../hypara/M1-N/parameter_d4.csv'
    SavePath = '../../hypara/M1-N/test_result_d4.csv'
    seed = 2560
...
def Test(x,D,round_no):
    ...
    np.savetxt('../../result/M1-N/prediction_d4.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/M1-N/groundtruth_d4.csv', y_test_save, delimiter=',')
