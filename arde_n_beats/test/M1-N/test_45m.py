...
class config:
    ...
    datapath = '../../data/M1-N/D_45m.csv'
    ParaPath = '../../hypara/M1-N/parameter_d3.csv'
    SavePath = '../../hypara/M1-N/test_result_d3.csv'
    seed = 2560
...
def Test(x,D,round_no):
    ...
    np.savetxt('../../result/M1-N/prediction_d3.csv', predictions_test, delimiter=',')
    np.savetxt('../../result/M1-N/groundtruth_d3.csv', y_test_save, delimiter=',')
